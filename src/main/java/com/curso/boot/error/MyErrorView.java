...
@Component			//Transformando a classe em um Bean do Spring
public class MyErrorView implements ErrorViewResolver {

	@Override	//HttpStatus - tem dados referente ao erro dos stts q ocorreu. Model - msgs referentes ao erro
	public ModelAndView resolveErrorView(HttpServletRequest request, HttpStatus status, 
		...
		//Traduzindo as msgs de erro. Se souber os possíveis erros q podem gerar, pode adicionar no case
		switch (status.value()) {
			case 404:
